      ...
      properties: {
        ...
        profile: {
          ...
          properties: {
            ...
            age: { bsonType: ["double", "int", "long"], minimum: 13, maximum: 100 },
            weight: { bsonType: ["double", "int", "long"], minimum: 25, maximum: 250 },
            height: { bsonType: ["double", "int", "long"], minimum: 120, maximum: 220 },
            activity: { enum: ["sedentary", "light", "moderate", "active", "athlete"] },
  ...
  foodEntries: {
    $jsonSchema: {
      ...
      properties: {
        ...
        servings: { bsonType: ["double", "int", "long"], minimum: 0.5, maximum: 20 },
        kcal: { bsonType: ["double", "int", "long"], minimum: 0 },
        protein: { bsonType: ["double", "int", "long"], minimum: 0 },
        carbs: { bsonType: ["double", "int", "long"], minimum: 0 },
        fat: { bsonType: ["double", "int", "long"], minimum: 0 },
        createdAt: { bsonType: "string" },
      },
    },
  },
